export default {
  payPeriod: {
    ...
    metrics: 'A series of metrics calculated from your income and expenses during this Pay Period',
  ...
  monthly: {
    metrics: 'A series of metrics calculated from your monthly income and expenses',
