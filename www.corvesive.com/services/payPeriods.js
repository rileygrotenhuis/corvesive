class PayPeriodsService {
  async getPayPeriods() {
    const response = await fetch(`${useRuntimeConfig().public.apiUrl}/pay-periods`, {
      method: 'GET',
      headers: {
  ...
  async getPayPeriod(payPeriodId) {
    const response = await fetch(`${useRuntimeConfig().public.apiUrl}/pay-periods/${payPeriodId}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  async deletePayPeriod(payPeriodId) {
    await fetch(`${useRuntimeConfig().public.apiUrl}/pay-periods/${payPeriodId}`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  async completePayPeriod(payPeriodId) {
    await fetch(`${useRuntimeConfig().public.apiUrl}/pay-periods/${payPeriodId}/complete`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  async incompletePayPeriod(payPeriodId) {
    await fetch(`${useRuntimeConfig().public.apiUrl}/pay-periods/${payPeriodId}/incomplete`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
