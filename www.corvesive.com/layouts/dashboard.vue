...
import PayPeriodTabs from '~/components/navigation/PayPeriodTabs.vue';
    ...
    <main>
      <div v-if="useAccountStore().user">
        ...
        <div v-else class="w-11/12 max-w-[1000px] mx-auto">
          <div class="mt-4 mb-2 font-bold text-gray-700">Pay Period</div>
          <PayPeriodHeader />
          <PayPeriodTabs class="mt-8 mb-8" />
          <slot />
        </div>
      </div>
    </main>
