...
use App\Http\v1\Queries\CreditAccountQuery;
use App\Http\v1\Requests\StoreCreditAccountRequest;
use App\Http\v1\Requests\UpdateCreditAccountRequest;
use App\Http\v1\Resources\CreditAccountResource;
