...
const submit = () => {
    form.post(props.bill.data.is_payed
...
<template>
    <AuthenticatedLayout>
        <h1 class="text-4xl text-center font-semibold">{{ bill.data.name }}</h1>
        <div class="mt-8 text-center">
            <h3 class="text-2xl font-semibold">${{ (bill.data.amount / 100).toFixed(2) }}</h3>
