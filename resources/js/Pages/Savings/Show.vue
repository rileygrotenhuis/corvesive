...
const submit = () => {
    form.post(props.saving.data.is_payed
...
<template>
    <AuthenticatedLayout>
        <h1 class="text-4xl text-center font-semibold">{{ saving.data.name }}</h1>
        <div class="mt-8 text-center">
            <h3 class="text-2xl font-semibold">${{ (saving.data.amount / 100).toFixed(2) }}</h3>
